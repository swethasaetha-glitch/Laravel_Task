...
<div class="mb-4">
    ...
    <h2 class="fw-bold mt-2">Edit Lay Model: {{ $layModel->lay_model_code }}</h2>
</div>

<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        <form action="{{ route('lay-models.update', $layModel) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row g-3">
                <div class="col-md-6">
                    <label for="lay_model_code" class="form-label fw-semibold">Lay Model Code <span class="text-danger">*</span></label>
                    <input type="text" name="lay_model_code" id="lay_model_code" class="form-control @error('lay_model_code') is-invalid @enderror" value="{{ old('lay_model_code', $layModel->lay_model_code) }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="lay_model_name" id="lay_model_name" class="form-control @error('lay_model_name') is-invalid @enderror" value="{{ old('lay_model_name', $layModel->lay_model_name) }}" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" min="0" name="lay_length" id="lay_length" class="form-control @error('lay_length') is-invalid @enderror" value="{{ old('lay_length', $layModel->lay_length) }}" required>
                    @error('lay_length')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" min="0" name="lay_width" id="lay_width" class="form-control @error('lay_width') is-invalid @enderror" value="{{ old('lay_width', $layModel->lay_width) }}" required>
                    @error('lay_width')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" min="0" name="number_of_plies" id="number_of_plies" class="form-control @error('number_of_plies') is-invalid @enderror" value="{{ old('number_of_plies', $layModel->number_of_plies) }}" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="garment_size" id="garment_size" class="form-control @error('garment_size') is-invalid @enderror" value="{{ old('garment_size', $layModel->garment_size) }}">
                    @error('garment_size')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" min="0" name="marker_length" id="marker_length" class="form-control @error('marker_length') is-invalid @enderror" value="{{ old('marker_length', $layModel->marker_length) }}">
                    @error('marker_length')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" min="0" name="marker_width" id="marker_width" class="form-control @error('marker_width') is-invalid @enderror" value="{{ old('marker_width', $layModel->marker_width) }}">
                    @error('marker_width')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" id="description" rows="3" class="form-control @error('description') is-invalid @enderror">{{ old('description', $layModel->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const selectedFabricId = @json(old('fabric_id', $layModel->fabric_id));
